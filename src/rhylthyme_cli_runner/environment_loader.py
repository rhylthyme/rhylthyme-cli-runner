...
class EnvironmentLoader:
    ...
    def load_environment(self, environment_id: str) -> Dict[str, Any]:
        ...
        if environment_file is None:
            raise FileNotFoundError(f"Environment '{environment_id}' not found in {self.environments_dir}")
        ...
        if 'environmentId' not in environment_data:
            raise ValueError(f"Environment file {environment_file} missing required 'environmentId' field")
        
        if 'resourceConstraints' not in environment_data:
            raise ValueError(f"Environment file {environment_file} missing required 'resourceConstraints' field")
    ...
    def find_suitable_environments(self, program_data: Dict[str, Any]) -> List[Dict[str, str]]:
        """
    ...
    def merge_constraints(self, program_constraints: List[Dict[str, Any]], 
                         environment_id: Optional[str]) -> List[Dict[str, Any]]:
        """
